...
if index_experiment == 2:
    ...
    print("---")
    os.system('python train.py params.json -g 0 --no_confirm_delete --n_experiments 1'
              ' --n_per_run 50 --experiment_name ' + experiment_name + ' --pos_weight=' + str(pw))
    print("")
    print("---")
    ...
    cutoff_eval = 0.5
    save_name = "eval_cutoff_0"
    os.system('python evaluate.py --model_path ' + model_path + ' -g 0 --n_experiments 1 --n_per_run 50 '
